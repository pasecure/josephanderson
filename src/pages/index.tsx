...
const Index: NextPage = () => {
  return (
    ...
    <Head>
        ...
        <meta property="og:title" content="Explore - Joseph Sullivan Anderson" />
        ...
        <div className="h-full">
          ...
          <div className="flex w-full flex-col gap-9 px-[26px] lg:flex-row lg:px-[96px]">
            <div className="mt-[-120px]">
              <div className="bg-[url('/new_assets/joseph_pass.jpeg')]  h-[259px] bg-cover bg-center object-cover lg:w-[259px]"></div>
