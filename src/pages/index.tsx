        ...
        <div className="h-full">
          ...
          <footer className="w-full bg-[#ffffff] py-6 px-4 md:px-10">
              <div className="md:flex md:flex-wrap md:justify-between md:gap-10">
                ...
                <div className="links">
                  <div>
                    <button ref={buttonRef} className="border-black text-sm font-medium text-black hover:border-b-[1px]" onClick={() => setSelectedIndex(0)}>
                      HOME
                    </button>
                  </div>
                  <div className="mt-2">
                    <button ref={buttonRef} className="border-black text-sm font-medium text-black hover:border-b-[1px]" onClick={() => setSelectedIndex(1)}>
                      ABOUT
                    </button>
                  </div>
                  <div className="mt-2">
                    <button ref={buttonRef} className="border-black text-sm font-medium text-black hover:border-b-[1px]" onClick={() => setSelectedIndex(2)}>
                      MY TEAM
                    </button>
                  </div>
                  <div className="mt-2">
                    <button ref={buttonRef} className="border-black text-sm font-medium text-black hover:border-b-[1px]" onClick={() => setSelectedIndex(3)}>
                      PLANNING
                    </button>
                  </div>
                </div>
